...
class VehiculoManager {
    constructor() {
        // Detectar la ruta correcta basada en la página actual
        const currentPath = window.location.pathname;
        if (currentPath.includes('admin_dashboard.php')) {
    ...
    async obtenerVehiculo(id) {
        try {
            ...
            console.log('Solicitando vehículo con URL:', `${this.apiUrl}?${params}`);
            ...
            try {
                ...
                throw new Error('Respuesta del servidor no es JSON válido. Revisar logs del servidor.');
            }
